...
export default class Camera{
    ...
    panHorizontal(amount) {
        ...
        vec3.add(this.target,this.right.map(e=>e*vec3.dist(this.target, this.position)*amount),this.target)
        vec3.add(tempVec, this.right.map(e=>e*vec3.dist(this.target, this.position)*amount), this.position)
    ...
    panVertical(amount) {
        ...
        vec3.add(this.target,this.up.map(e=>e*vec3.dist(this.target, this.position)*amount),this.target)
        vec3.add(tempVec, tempVec.map(e=>e*vec3.dist(this.target, this.position)*amount), this.position)
    ...
    zoom(amount) {
        ...
        vec3.add(tempVec, this.forward.map(e=>e*vec3.dist(this.position, this.target)/5*amount), this.position)
        this.setPosition(tempVec)
    }
    orbitX(amount) {
